...
const url = "https://turkey-api-2k7c.vercel.app/api/turkey/get_productos?category_id=1";
getData();
async function getData(){
  ...
  for (let i = 0; i < data.length; i++) {
    ...
    let newProduct ={
        ...
        const other = await fetch("https://turkey-api-2k7c.vercel.app/api/turkey/get_material_name?product_material_id="+ camisas_tabla[i].product_material_id,{
...
function crearWidget(messi,i){
  ...
  let img = document.createElement('img');
      ...
      p1.innerText = camisas_tabla[i].product_name;
      let p2 = document.createElement('p');
      p2.innerText = camisas_tabla[i].product_title;
      let p3 = document.createElement('p');
      p3.classList.add('tela');
      p3.innerText = camisas_tabla[i].product_material_id;
      div3.appendChild(p1);
      div3.appendChild(p3);
      div3.appendChild(p2);
